...
- Create Angular project with ng: `ng new predictivemaintenance.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`predictivemaintenance.client.esproj`).
